...
import { Button, Currency, FlexCol, ImageRatio, LinkCustom, Pagination } from '@/components';
...
export const TradeTab = ({ token }: { token: ITokenInfo }) => {
  const [page, setPage] = useState(1);
  const { data } = useQueryTrades(token.mint, token.network, page);
